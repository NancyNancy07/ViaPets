...
public class test
{
  public static void main(String[] args)
  {
    ...
    Customer customer1 = new Customer("TurboMode Doe", "1234 Main St", "asd321@gmail.com");
    ...
    ViaPetsShop shop = new ViaPetsShop();
    shop.setCustomerList(customers);
    ViaPetsModelManager modelManager = new ViaPetsModelManager("customers.bin", "pets.bin", "sales.bin", "kennelReservations.bin", shop);
...
//    System.out.println(customersFromFile);
    ...
    System.out.println(     modelManager.readCustomers());
  }
}
